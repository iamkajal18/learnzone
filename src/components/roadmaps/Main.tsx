        ...
        {roadmapItems.map((item, index) => (
          <div
            ...
            className={`group relative transition-all duration-500 ease-out ${
              itemsLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
            }`}
            style={{
...
const RoadMapHeader = ({ isParentLoaded }: { isParentLoaded: boolean }) => {
  ...
  return (
    <div className={`max-w-4xl mx-auto text-center mb-3 relative transition-all duration-700 ease-out ${
      ...
      <p className={`text-gray-600 dark:text-gray-300 text-base sm:text-lg mt-6 mb-8 max-w-3xl mx-auto leading-relaxed transition-all duration-700 ease-out delay-100 ${
      ...
      <div className={`flex flex-wrap justify-center gap-3 transition-all duration-700 ease-out delay-200 ${
        headerLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-3'
      }`}>
        {[
...
const RoadMap = () => {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-opacity duration-700 ease-out ${
      isLoaded ? 'opacity-100' : 'opacity-0'
    }`}>
      <div className={`absolute inset-0 opacity-30 transition-opacity duration-1000 ease-out ${
